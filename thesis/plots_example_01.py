...
def plot_example01_gpe2nd_constans():
...
def plot_example01_gpe4th_constans():
...
def main():
    #plot_example01()
    #plot_example01_width()
    #plot_example01_comp_interval()
    #plot_example01_gpe2nd_constans()
    plot_example01_gpe4th_constans()
