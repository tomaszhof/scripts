...
#./gpe_tester --e=4 --alpha1=1 --alpha2=2 --beta1=1 --beta2=2 --m=40 --out_file='fp_res/ex02_m_40_fp.txt' --arth_mode=pint --exp_mode='classical_exp' --print_csv='true'
...
./gpe_tester --e=4 --alpha1=1 --alpha2=2 --beta1=1 --beta2=2 --m=40 --out_file='pint_res/ex02_m_40_pint.txt' --arth_mode=pint --exp_mode='interval_exp' --print_csv='true'
...
./gpe_tester --e=4 --alpha1=1 --alpha2=2 --beta1=1 --beta2=2 --m=40 --out_file='dint_res/ex02_m_40_dint.txt' --arth_mode=dint --exp_mode='interval_exp' --print_csv='true'
